...
public class BasicBinderModule extends AbstractModule {
  ...
  @Provides
  @Inject
  public List<AbstractDataRepository> dataRepositories(PlayersRepository playersRepository,
    ...
    return List.of(playersRepository, questsRepository, questObjectivesRepository,
        questRequirementsRepository, questRewardsRepository);
